...
const fix = (name) => {
  const fixed = name
    ...
    .replace(
      '63 boulevard des Invalides 63 boulevard des Invalides Vélos Direction Centre de Paris',
      'Boulevard des Invalides'
    )
    .replace(
      '63 boulevard des Invalides 63 boulevard des Invalides Vélos Direction Hors Centre de Paris',
      'Boulevard des Invalides'
    )
    .replace('(prêt)', '')
    .replace('Logger_IN', '')
